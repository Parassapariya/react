export default function Home() {
    return (
        <>
                    ...
                    <div className="row">
                        <div className="col-lg-6 offset-lg-6">
                            <div className="pa-banner-text">
                                <h4 className="pa-banner-category">Aloevera Cream</h4>
            ...
            {/* why end */}
            {/* product start */}
            <div className="pa-product spacer-top">
                <div className="container">
                    <div className="pa-heading">
                        <img src="assets/images/herbal.svg" alt="image" className="img-fluid" />
                        <h1>top products</h1>
            ...
            <div className="pa-counter spacer-top spacer-bottom">
                <div className="container">
                    ...
                    <div className="pa-counter-main" id="counter">
                        <div className="row">
                            <div className="col-lg-3 col-sm-6">
                                <div className="pa-counter-box">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  c-0.8-0.4-1.6-0.8-2.4-0.8c-4.4-0.8-8.8,2.4-9.6,7.2l-7.2,47.6l-57.6-100.4c24-7.2,45.6-19.6,63.6-35.6l57.6,99.6L360.295,379.6z"
                                        ...
                                        <g>
                                            <path
                                                d="M312.295,140.8c-2-2.8-4.4-4.8-7.2-6s-6-2-9.2-1.6h-33.2l-10.4-32.8c-1.6-4.8-5.2-8.8-9.2-11.2c-2.8-1.2-5.6-2-8.8-2
                                  ...
                                  C299.095,152.8,298.695,153.2,298.295,153.6z"
                                        ...
                                        <g>
                                            <path
                                                d="M327.895,76.4c-24-24-57.2-38.8-94-38.8s-70,14.8-94,38.8s-38.8,57.2-38.8,94s14.8,70,38.8,94s57.2,38.8,94,38.8
                                  ...
                                  S337.095,231.6,316.295,252.4z"
                                    ...
                                    <h1 className="counter-value" data-count={25}>
                                        0
                                    </h1>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="pa-counter-box">
                                    ...
                                    <h1 className="counter-value" data-count={800}>
                                        0
                                    </h1>
                                    <span> +</span>
                                    <p>products</p>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="pa-counter-box">
                                    ...
                                    <h1 className="counter-value" data-count={100}>
                                        0
                                    </h1>
                                    <span> %</span>
                                    <p>Product purity</p>
            ...
            <div className="pa-trending-product">
                <div className="container">
                    <div className="pa-heading">
                        <img src="assets/images/herbal.svg" alt="image" className="img-fluid" />
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="pa-blog-box">
                                ...
                                <div className="pa-blog-title">
                                    <a href="#" className="pa-blog-category">
                                        Ayurveda Medicine
                                    </a>
                                    <h2>
                                ...
                                <div className="pa-blog-view">
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <i className="far fa-heart" /> 900
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i className="fas fa-eye" /> 830
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
